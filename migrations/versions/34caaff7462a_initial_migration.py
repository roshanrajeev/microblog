...
Revision ID: 34caaff7462a
Revises: 
Create Date: 2020-12-16 10:22:43.657331
...
def upgrade():
    ...
    sa.Column('has_unseen_messages', sa.Boolean(), server_default='f', nullable=True),
